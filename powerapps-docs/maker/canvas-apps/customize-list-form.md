...
На сайте SharePoint создайте список и добавьте следующие столбцы:
...
В центре экрана PowerApps отображает вашу форму, но она содержит ненужные поля.

- На панели **Данные** снимите флажки для полей **Заголовок** и **Вложения**.

    Эти поля будут скрыты, и будут отображаться только добавленные вами поля.
...
Если вы создаете в этой форме один или несколько элементов, поле **Заголовок** будет пустым. Это поле можно скрыть, изменив представление по умолчанию.
