...
<br>Авторы: Одри Гордон (Audrie Gordon) и Клей Весенер (Clay Wesener)
<br>*1 мая, 10:00 по тихоокеанскому времени, 12:00 по восточному поясному времени*

Совместная работа с Клеем Весенером (Clay Wesener) из группы PowerApps, в рамках которой он рассказывает о создании базы данных CDS for Apps. Вы узнаете, как создавать сущности и поля, а также перемещаться по ним. Вы также сможете быстро понять, какие возможности встроены в продукт и готовы к использованию. 

Это первая часть из трех.
<br>**Часть 1. Сущности**
<br>Часть 2. Формы и представления
<br>Часть 3. Диаграммы и панели мониторинга

Это отличная возможность узнать, как повторно использовать стандартные сущности и поля и как легко создать собственные пользовательские сценарии.

[Щелкните здесь, чтобы просмотреть вебинар 1 мая](https://www.youtube.com/watch?v=02NWfHRYkeo)
...
<br>Авторы: Одри Гордон (Audrie Gordon) и Клей Весенер (Clay Wesener)
<br>*15 мая, 10:00 по тихоокеанскому времени, 12:00 по восточному поясному времени*

Приложения на основе модели предоставляют широкие возможности создателям приложений, проектирующим как простые, так и сложные сценарии форм. Вы можете узнать, как использовать наш новый конструктор форм для создания форм, необходимых для приложения модели, с которым мы начали работать в части 1. Анис (Anees) расскажет вам о компонентах формы, таких как вкладки, разделы и поля. Он также даст полезные советы по интеграции бизнес-логики и фильтров. 

Это вторая часть из трех.
<br>Часть 1. Сущности
<br>**Часть 2. Формы и представления**
<br>Часть 3. Диаграммы и панели мониторинга

[Щелкните здесь, чтобы просмотреть вебинар 15 мая](https://www.youtube.com/watch?v=v7VoX-V2ek4)

**Серия статей о приложениях на основе моделей. Часть 3 | Обзор диаграмм и панелей мониторинга**
<br>Авторы: Одри Гордон (Audrie Gordon) и Клей Весенер (Clay Wesener)
<br>*29 мая, 10:00 по тихоокеанскому времени, 12:00 по восточному поясному времени

PowerApps обеспечивает комплексный подход к ведению отчетов с обширными возможностями работы с представлениями и панелями мониторинга. Наша серия вебинаров по приложению на основе модели охватывает полезные диаграммы и панели мониторинга, позволяющие оптимизировать и модернизировать разрабатываемое решение. 

Это последняя часть из трех.
<br>Часть 1. Сущности
<br>Часть 2. Формы и представления
<br>**Часть 3. Диаграммы и панели мониторинга**

[Щелкните здесь, чтобы просмотреть вебинар 29 мая](https://www.youtube.com/watch?v=kJ5eTWh7Hyg)
...
### <a name="model-driven-apps"></a>Приложения на основе моделей ###
**Компоненты приложений на основе моделей | Общие сведения о приложениях на основе моделей**
<br>Авторы: Чарльз Стерлинг (Charles Sterling) и Адриан Орт (Adrian Orth) [Смотреть](https://www.youtube.com/watch?v=buDDSzJTgns)

**Компоненты приложений на основе моделей | Начало работы с шаблонами на основе моделей**
<br>Авторы: Чарльз Стерлинг (Charles Sterling) и Кейси Бёрк (Casey Burke) [Смотреть](https://www.youtube.com/watch?v=FShakkXKiS8)
...
<br>Автор: Давид ван Херден (Dawid van Heerden) [Смотреть](https://www.youtube.com/watch?v=Jj3hPkAf5KU)
