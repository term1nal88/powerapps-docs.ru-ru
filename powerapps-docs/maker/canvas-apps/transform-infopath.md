...
[**Справочник по формулам**](https://docs.microsoft.com/powerapps/formula-reference) — даже если вы просто будете просматривать стандартные формулы, вам в голову может прийти отличная идея.
