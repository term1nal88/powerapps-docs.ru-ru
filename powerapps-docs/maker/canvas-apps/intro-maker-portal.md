...
Рядом с раскрывающимся списком сред находится значок скачивания. Выберите этот значок, чтобы отобразить диалоговое окно со ссылками на скачивание PowerApps Mobile (для устройств iOS или Android).
...
Выберите **Начало работы** на этом баннере, чтобы отобразить параметры для создания приложения с помощью **PowerApps Studio**.
...
* Теперь приложение открывается в новой вкладке PowerApps Studio.
