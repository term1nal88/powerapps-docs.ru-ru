...
> [!NOTE]
> Приложение также можно создать на основе [пользовательского списка SharePoint](app-from-sharepoint.md).
...
3. Откройте список внизу, а затем щелкните или нажмите **Category** (Категория).
    ...
    > [!NOTE]
> По умолчанию вы можете просмотреть список (который называется коллекцией), используя колесико мыши или прокручивая сенсорный экран вверх и вниз. Если у вас сенсорная панель или мышь без колесика, выберите коллекцию, щелкните или нажмите **ShowScrollbar** в списке свойств и замените значение **false** значением **true** в строке формул.
