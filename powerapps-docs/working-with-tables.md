...
1. Добавьте элемент управления **Коллекция текста** и укажите в качестве значения его свойства **[Items](controls/properties-core.md)** имя таблицы.
    ...
    **Примечание.** Для большей наглядности на иллюстрациях мы изменили относительное расположение некоторых элементов управления и увеличили их размер.
...
* Для доступа к значениям из вложенных областей записей воспользуйтесь оператором **@**, указав имя обрабатываемой таблицы в формате ***Table*[@*FieldName*]**.  
* Чтобы получить доступ к глобальным значениям, таким как источники данных, коллекции и переменные контекста, воспользуйтесь шаблоном **[@*ObjectName*]** (без обозначения таблицы).
