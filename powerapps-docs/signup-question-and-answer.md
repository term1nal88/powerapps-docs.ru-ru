...
### <a name="how-can-restrict-my-users-ability-to-access-my-organizations-business-data-using-powerapps"></a>Как можно ограничить возможность доступа пользователей к бизнес-данным моей организации с помощью PowerApps?
...
**Примечание.** Если этот параметр не отображается, администратор Office 365 уже существует.
...
**ВНИМАНИЕ!** Механизм автоматического перемещения пользователей между клиентами после их создания не предусмотрен. Дополнительные сведения о добавлении доменов к одному клиенту Office 365 см. в статье [Добавление пользователей и домена с помощью мастера настройки](https://support.office.com/article/Add-your-users-and-domain-to-Office-365-ffdb2216-330d-4d73-832b-3e31bcb5b2a7).
