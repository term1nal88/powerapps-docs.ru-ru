...
Все сущности — стандартные или пользовательские — создаются с набором полей только для чтения, которые нельзя изменить, удалить или настроить. Дополнительные сведения см. в разделе [System and record title fields](data-platform-create-entity.md#system-fields-and-the-record-title-field) (Системные поля и поля с заголовком записи). Ниже приведены самые важные системные поля:
