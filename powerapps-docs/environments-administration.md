...
* Перейдите на сайт [powerapps.com][2], а затем щелкните значок с шестеренкой вверху панели навигации.
...
* роль администратора этой среды;
* роль глобального администратора клиента Azure AD или клиента Office 365.
...
**Важно.** Все изменения, внесенные в центре администрирования PowerApps, применяются в [центре администрирования Flow][4] и наоборот.
...
* Роль **администратора среды** позволяет выполнять все административные действия в среде, в том числе:
  ...
  назначать пользователям и группам роли администратора среды или разработчика среды и отменять это назначение;
  
  подготавливать для среды базы данных Common Data Service;
  
  просматривать любые ресурсы, созданные в среде, и управлять ими;
