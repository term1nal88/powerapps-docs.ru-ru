...
3. Щелкните ссылку для управления ролями среды в Dynamics 365.

    ![](./media/environment-admin/Security-Link-D365.png)

4. Выберите пользователя в списке пользователей в среде.

    ![](./media/environment-admin/D365-Select-User.png)

5. Назначьте роль пользователю.
...
6. Нажмите кнопку **ОК**, чтобы обновить назначения для роли среды.
