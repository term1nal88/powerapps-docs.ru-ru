---
title: Реагирование на запросы по правам субъекта данных для данных клиента CDS for Apps | Документы Майкрософт
description: Пошаговое руководство по реагированию на запросы по правам субъекта данных для данных клиента CDS for Apps.
services: powerapps
suite: powerapps
