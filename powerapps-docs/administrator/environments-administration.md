...
> [!IMPORTANT]
> Выполните действия, описанные в этом разделе, чтобы переименовать рабочую среду, которая не содержит базу данных. Вы не можете переименовать среду в пробной версии и должны использовать Центр администрирования Dynamics 365 для переименования рабочих сред с базами данных.
