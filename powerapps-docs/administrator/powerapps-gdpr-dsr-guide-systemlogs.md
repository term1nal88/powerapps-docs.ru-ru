---
title: Реагирование на запросы по правам субъекта данных (DSR) на получение системных журналов в PowerApps, Microsoft Flow и Common Data Service for Apps | Документы Майкрософт
description: Пошаговое руководство о том, как реагировать на запросы по правам субъекта данных (DSR) на получение системных журналов в PowerApps, Microsoft Flow и Common Data Service for Apps
services: powerapps
suite: powerapps
